...
public class UserOrderListServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            int orderID_raw = Integer.parseInt(orderID);
            
            OrderDetailsDAO dao = new OrderDetailsDAO();
            List<OrderDetailsDTO> l = dao.findOrder(username, orderID_raw); // get list order
            request.setAttribute("ORDER_DETAILS_LIST", l);
