<%-- 
    Document   : allOrder
    Created on : Nov 1, 2023, 2:58:32 PM
    Author     : nguye
--%>
...
<html>
    ...
    <body>
        ...
        <h3 style="margin: 30px">Manage Order</h3>

        <%
            List<OrderDTO> listOrder = (List<OrderDTO>) request.getAttribute("ALL_ORDER");
        ...
        %>
        <p style="color: #C63100; text-align: center">No orders yet!</p>
        <%
            }
        %>
    </table>
