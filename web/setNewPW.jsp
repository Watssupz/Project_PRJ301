<%-- 
    Document   : setNewPW
    Created on : Oct 25, 2023, 10:17:07 PM
    Author     : nguye
--%>
...
<html>
    ...
    <body>
        <div class="container">
            ...
            <form action="DispatchController" method="post">
                ...
                <div class="row">
                    <div class="form-group col-md-6" style="text-align: center">
                        ...
                        <button class="btn btn-primary" type="submit" name="btAction" value="SetNewPW">Change</button>
                    </div>
                    <div class="form-group col-md-6" style="text-align: center">
            ...
            <%
                    if(request.getAttribute("ERROR_MATCH") != null){
                        String error_match = (String) request.getAttribute("ERROR_MATCH");
            %>
            <p style="color: #C63100"><%= error_match%></p>
            <%
                }
            %>
